const myModulo = (() => {
  ...
  return {
    pericua: perimetro_cuadrado,
    area_cua: calcularArea,
    peri_tri: perimetro_triangulo,
    area_tri: calcularAreaTri,
    peri_cir: perimetro_circulo,
    area_cir: area_circulo,
    diam_cir: diametro_circulo
  };
